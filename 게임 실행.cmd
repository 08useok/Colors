...
powershell -NoProfile -ExecutionPolicy Bypass -WindowStyle Hidden -Command ^
  ...
  "function Test-Server { try { Invoke-WebRequest -Uri ($url + '/index.html') -UseBasicParsing -TimeoutSec 2 | Out-Null; return $true } catch { return $false } };" ^
  "if (-not (Test-Server)) {" ^
  ...
  "};" ^
  "if (Test-Server) { Start-Process ($url + '/index.html') }" ^
