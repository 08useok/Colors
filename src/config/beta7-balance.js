...
export const BETA7_BALANCE = {
  ...
  ivory: { maxHealth: 6600, iceCreamDamage: 2200, iceCreamZoneRadius: 5, iceCreamZoneTickInterval: 0.25 },
...
export function applyBeta7Balance(source) {
  ...
  for (const [id, { ultimate, ...stats }] of Object.entries(BETA7_BALANCE)) {
