...
| `crown_cyan` | Cyan | 우승 왕관 | 희귀 | 무료 | `beta1` |
| `crown_pink` | Pink | 준우승 왕관 | 희귀 | 무료 | `beta1` |
| `crown_green` | Green | 3위 왕관 | 희귀 | 무료 | `beta1` |
...
const SKINS = {
  ...
  crown_cyan:  { name: "우승 왕관",   character: "cyan",  season: "beta1", cost: 0, desc: "skinCrownCyanDesc",  rarity: "rare" },
  crown_pink:  { name: "준우승 왕관", character: "pink",  season: "beta1", cost: 0, desc: "skinCrownPinkDesc",  rarity: "rare" },
  crown_green: { name: "3위 왕관",    character: "green", season: "beta1", cost: 0, desc: "skinCrownGreenDesc", rarity: "rare" },
};
```
...
- `crown_cyan`, `crown_pink`, `crown_green`은 각각 베타 시즌 1의 1위·2위·3위 기념 왕관 외형을 적용한다.
...
- [ ] 상점 스킨 탭에 `crown_pink`, `crown_green`, `crown_cyan` 왕관 스킨 3종이 표시된다
...
- [ ] 베타 캐릭터 화면에서 장착 중인 스킨을 해제하면 즉시 기본 외형으로 돌아간다
